...
files_to_process <- grep("1:10",files_to_process,value = TRUE)
...
for (file in files_to_process){
  ...
  for (timepoint in 1:70){
    ...
    created_file_path <- file.path(target_path,"posture",paste0("200428_",annotation,"_timepoint_",timepoint,"_skeletonized.rds"))
