...
created_file_path <- file.path(save_path,"201005_omega_turns.rds")
...
```{r, include=FALSE}
imported_data <- readRDS(file.path(save_path,"201005_omega_turns.rds"))
library(wesanderson)
...
plotting_function(imported_data %>% filter(annotation == "Agar" | annotation == "Agar with NAD"))
