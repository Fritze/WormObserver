...
selected_annotation <-  c("OP50_skeletonized_")
...
#number sampled tracks Agar 400
...
saveRDS(PC_values, file.path(save_path,paste0(annotation,"_400tracks_PC_values.RDS")))
