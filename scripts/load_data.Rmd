...
#define data paths
target_folder_base <- ("/home/fpreuss/raid/timelapses")
...
list_of_datasets <- matrix(c(
  ...
  "2020-02-21_15-58-43", "N2 1:10 after 6h exit",
  "2020-03-03_19-35-55", "N2 1:10 after 6h exit",
...
for (row in 1:nrow(nested_list_of_datasets)){
  ...
  imported_data <-  unlist(map(target_folder_analysis,find_zip_files)) %>%
    ...
    created_file_path <- file.path(save_path,paste0("200319_", annotation_underscored, "_raw_data.rds"))
