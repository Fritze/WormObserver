...
save_path <- "/home/fpreuss/raid/timelapses/analysis/200318/plots/posture/heatmaps"


skeletons_filtered_clustered_filepath <- list.files(path = target_folder,pattern="200428.+skeletons_filtered_clustered.RDS",ignore.case = TRUE, full.names = TRUE)
clustering_filepath <- list.files(path = target_folder,pattern="200428.+clustering.RDS",ignore.case = TRUE, full.names = TRUE)
cluster_centers_reduced_filepath <- list.files(path = target_folder,pattern="200428.+_cluster_centers_reduced.RDS",ignore.case = TRUE, full.names = TRUE)
...
save_path_comparison <- "/home/fpreuss/raid/timelapses/analysis/200318/plots/posture/postures_comparison_plots"
...
#  Individual heatmaps for each dataset
...
for (a in annotations){
 ...
 plot_posture_heatmap(heatmap_data_to_plot_per_dataset,ordering) +
    ...
    ggsave(file.path(save_path,paste0("200511_heatmap_",a,"_",n,"_per_dataset",".png")),width=40,height=30)
  ...
  heatmap /
    ...
    ggsave(file.path(save_path,paste0("200511_heatmap_",a,"_",n,".png")),width=40,height=30)
