...
target_path <- file.path(base_path,"data", "size_measurements")
...
for (file in files_to_process){
  ...
  imported_data_temp <- readRDS(file) %>%
    ...
    group_by(annotation,dataset_ID, tp,minutes,TrackID) %>%
    summarise(size=median(Size),major=median(Major),minor=median(Minor),midline=median(midline_length,na.rm = TRUE)) %>%
