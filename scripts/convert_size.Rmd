...
for (file in files_to_process){
  ...
  annotation <- unique(imported_data_temp$annotation)
  saveRDS(imported_data_temp, file.path(save_path, paste0("size_converted_",annotation ,".RDS")))
  print(paste0(annotation, " was converted and saved."))
}
