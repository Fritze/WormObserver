...
target_path <- file.path(base_path, "converted")
...
selected_annotations <- c("Agar_long_1","OP50_long_1")
...
selected_annotations <- c("Agar_long_1", "KQ1366_long_2","OP50_long_1")
selected_timepoints <- unique(imported_data$hours_rounded)
for (parameter in parameters){
