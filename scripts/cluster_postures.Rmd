...
# skeleton_data_filtered <- readRDS(file.path(target_folder_base,"200305_Skeletons_filtered.RDS"))
# dataset_name <- unique(skeleton_data_filtered$dataset_ID)

#transpose - rows: posture IDs, -columns: angles
angle_data_cluster <- skeleton_data_filtered_named %>%
...
saveRDS(angle_data_clustered, file=file.path(save_path,"200306_Skeletons_filtered_clustered.RDS"))
