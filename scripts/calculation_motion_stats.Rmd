...
annotations_already_processed <- unique(gsub(".+\\/(.+)\\_centroid.+","\\1",list.files(target_path, "centroid_tracking", full.names = TRUE, ignore.case = TRUE)))
...
files_to_process <- annotations_to_be_processed[!annotations_to_be_processed %in% annotations_already_processed]
#get file path
files_to_process <- list.files(target_path, paste0(files_to_process, "_raw_data"), full.names = TRUE, ignore.case = TRUE)
