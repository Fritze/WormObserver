...
if (length(files_to_process_cleaned) > 0){
  files_to_process <- list.files(target_path, paste0(files_to_process_cleaned, "_raw_data"), full.names = TRUE, ignore.case = TRUE)
  ...
  for (file in files_to_process){
    ...
    created_file_path <- file.path(save_path,paste0(annotation_underscored,"_centroid_tracking_tracks.RDS"))
    number_files_to_process <<- number_files_to_process - 1
