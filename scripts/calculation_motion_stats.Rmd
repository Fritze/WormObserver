...
target_folder <- "/home/fpreuss/raid/timelapses/analysis/200612/data"
...
for (file in files_to_process){
  ...
  created_file_path <- file.path(target_folder,paste0(annotation_underscored,"_centroid_tracking_bins.RDS"))
  ...
  created_file_path <- file.path(target_folder,paste0(annotation_underscored,"_centroid_tracking_tracks.RDS"))
  number_files_to_process <<- number_files_to_process - 1
