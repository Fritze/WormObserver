...
motion_1 <- readRDS(file=file.path(target_folder_base,"2000213_Motion_1_1.RDS"))
motion_2 <- readRDS(file=file.path(target_folder_base,"2000213_Motion_5.RDS"))
...
pal <- wes_palette("Darjeeling1",5)[c(1,5)]
