...
target_folder_base <- "/media/ella/raid5/timelapses/analysis/200305/motion"
save_path <- "/media/ella/raid5/timelapses/analysis/200305/motion"
...
print(ggplot(mean_velocity,aes(x=hours_rounded,y=mean,color=annotation,group=annotation))+
  geom_line(size=1)+
  geom_point()+
  geom_errorbar(width=.1, aes(ymin=mean-se, ymax=mean+se))+
  geom_ribbon(aes(ymin=mean-se, ymax=mean+se), fill="darkgray",linetype = 0, alpha=0.2)+
