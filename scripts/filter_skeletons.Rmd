...
target_folder_base <- "/media/ella/raid5/timelapses/analysis/200305/posture"
...
datasets <- c(
  ...
  "2020-02-20_18-53-49",#6honfood1:10
  ###"2020-02-21_15-58-43"#6honfood1:10
...
posture_7 <- readRDS(file=file.path(target_folder_base,files[7]))
posture_8 <- readRDS(file=file.path(target_folder_base,files[8]))
posture_9 <- readRDS(file=file.path(target_folder_base,files[9]))
posture_10 <- readRDS(file=file.path(target_folder_base,files[10]))
...
saveRDS(skeleton_data_filtered, file=file.path(target_folder_base,"200305_Skeletons_filtered.RDS"))
```
