...
save_path <- file.path(base_path,"plots","bins")
dir.create(save_path)
save_path <- file.path(save_path, average, "scatterplots")
dir.create(save_path)
...
#plot all 10s windows per annotation AND dataset_ID  
```{r, echo=TRUE}

save_path <- file.path(base_path,"plots","bins","scatterpoints")
dir.create(save_path)
...
save_path <- file.path(base_path,"plots","bins","scatterdensity")
dir.create(save_path)
...
save_path <- file.path(base_path,"plots","bins","scatterpoints_annotated")
dir.create(save_path)
