...
write.csv2(go_results_all,file=file.path(here(),"enriched_go_terms.txt"),row.names = FALSE)
...
ggplot(data = go_results_all_filtered, aes(x = tp, y = term_name, size = precision)) + 
  geom_point() +
...
ggsave(file.path(here(), paste0("A_vs_B_go_enrichment_doplot_over_all_tps",".png")),width=8,height=10)
