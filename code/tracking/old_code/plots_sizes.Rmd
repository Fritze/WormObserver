...
selected_timepoints <- c(seq(1,20))
selected_annotations <- c("Agar_long_2","OP50_long_2","OP50_w_Az_long_1")
...
```{r, include=FALSE}
selected_annotations <- c("Agar_long_1","OP50_long_2", "OP50_w_Az_long_1")
...
# OP50 vs Agar vs OP with Az (NGM)
```{r, include=FALSE}
selected_annotations <- c("Agar_long_1","OP50_with_Az_NGM_long_2","OP50_long_1")
selected_timepoints <- unique(imported_data$hours_rounded)
for (parameter in parameters){
