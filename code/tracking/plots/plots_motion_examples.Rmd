...
library(tidyverse)
#define base path
base_path <- "~/Desktop/paper/data/"
target_folder<- file.path(base_path, "raw")
files_to_process <- list.files(target_folder,"raw", full.names = TRUE, ignore.case = TRUE)

selected_annotation <- "HB101"
...
location_x_centered <- seq(51, 50+number_of_pixels)
...
ggsave(file.path(save_path,paste0(selected_annotation,"_hours_", paste0(selected_hours,collapse="_"),"_all_tracks_centered",".png")),height = 6,width= 9.5,dpi=300,bg = "transparent")
