...
datasets <- unique(imported_data$dataset_ID)
tps
datasets
# tic()
...
tic()
data_skeleton_headext <- data_skeleton %>%
...
#any(data_skeleton_headext$head_detected == "not yet")
...
unique(data_skeleton$dataset_ID)

unique(data_skeleton_headext$tp)
unique(data_skeleton_headext$TrackID)
unique(data_skeleton_headext$dataset_ID)
# 
unique(imported_data$tp)
unique(imported_data$TrackID)
# imported_data %>%
#   count(tp,TrackID) %>%
...
save(data_skeleton_headext, file = file.path(target_folder_base,"analysis","191122",paste0("2019-05-07_12-15-40","_","70tps","_","0-900","with_headext",".RData")))
