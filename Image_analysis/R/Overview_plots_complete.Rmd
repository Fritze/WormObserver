...
skeleton("2019-03-26_19-27-16",TrackIDs,tps,0:899)
...
calculate_eigenvalue_contribution <- function(timepoints,dataframe,frames){
  ...
  if(nrow(for_pca) != 0){
    ...
    # plot(pca)
    data.frame(pca$sdev^2,unique(for_pca_2$unique_tracks))
  } else {
    rep(0, 22)
  }
} 
...
frames <- 10
liste <- list(c(12:40), c(41:69))
timepoints <- liste

eigenvalues_all <- map_dfc(liste,calculate_eigenvalue_contribution,dataframe,10)
