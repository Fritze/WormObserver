...
calculate_overview_statistics <- function(offset,max_number_gaps,duration) {
  dfp <<- data %>%
    ...
    group_by(TrackID, tp, minutes, dataset_ID,file_name,plate_type,Duration_of_track) %>%
...
```{r, include=FALSE}
target_folder_general <- c("/media/ella/raid5/timelapses/2019-01-22_15-48-35", "/media/ella/raid5/timelapses/2019-01-23_16-07-02", "/media/ella/raid5/timelapses/2019-01-24_16-24-21","/media/ella/raid5/timelapses/2019-02-06_09-38-04")
...
params <- c("size_median_per_minute","eccentricity_median_per_minute","angle_median_per_minute", "velocity_median_per_minute", "sd_velocity_median_per_minute", "displacement_median_per_minute")
for (i in params){
print(ggplot(dfp2, aes_string(x="minutes",y=i))+
